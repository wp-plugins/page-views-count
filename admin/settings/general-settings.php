...
class WP_PVC_General_Settings extends WP_PVC_Admin_UI
{
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = array(
     		array(
            	'name' 		=> __( 'Plugin Framework Global Settings', 'pvc' ),
           	...
           	array(
           		'name'		=> __( 'Customize Admin Setting Box Display', 'pvc' ),
           		'desc'		=> __( 'By default each admin panel will open with all Setting Boxes in the CLOSED position.', 'pvc' ),
                'type' 		=> 'heading',
           	),
           	array(
		...
		$this->form_fields = array_merge( $this->form_fields, array(
			...
			array(
				'name' 		=> __( 'Page Views Count Function', 'pvc' ),
                'type' 		=> 'heading',
	...
	?>
		...
		<div><?php _e("There are 2 functions that you can use to manually add Page Views Count to any content or post type that is created by your theme or plugin that creates it's own table instead of using custom post types", 'pvc'); ?>.</div>
